...
export default function Navbar({ isLoggedIn, onLogout }: NavbarProps) {
  ...
  const handleLogout = () => {
    onLogout(); // Hapus token dan update state login
    router.push("/component/loginPage"); // Redirect ke halaman login
  };
            ...
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li className="relative">
                ...
                {isDropdownOpen && (
                  <div
                    id="dropdownNavbar"
                    className="absolute left-0 z-10 mt-2 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600"
                  >
              ...
              {isLoggedIn ? (
                ...
                <li>
                  <Link href="/component/loginPage">
                    <span className="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 cursor-pointer">
                      Login
                    </span>
                  </Link>
                </li>
